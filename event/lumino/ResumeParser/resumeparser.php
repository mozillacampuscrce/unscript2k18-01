            ...
            if (move_uploaded_file($fileToUpload['tmp_name'], $target_file)) {
                ...
                foreach ($fileInfo as $row) {
                    ...
                    // echo $part.'<br><br>';
                        ...
                        preg_match_all('production|Java| PHP| JavaScript| HTML5| C | MySQL | sales|call center|Accounts|marketting|tele communication|engineer|software engineering|software engineer|manufacturing|office administration|human resource|admin|secretarial|customer service|call center|finance account/', $part, $matches);
                        if (count($matches[0])) {
